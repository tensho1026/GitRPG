        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3 min-w-0">
            <Link href="/home" aria-label="ホームへ戻る" className="shrink-0">
              <span
                aria-label="ホームへ戻る"
                className="touch-target flex items-center justify-center p-3 border-3 bg-green-600 border-green-400 text-white pixel-border hover:bg-green-500 focus-visible:outline-2 focus-visible:outline-yellow-300"
