    ...
    <div
      ...
      style={{
        ...
        backgroundImage: `
          ...
          radial-gradient(circle at 75% 75%, rgba(239, 68, 68, 0.3) 2px, transparent 2px)
        `,
      ...
      <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <button
                  ...
                  className="p-3 border-3 bg-red-600 border-red-400 text-white pixel-border hover:bg-red-500"
        ...
        <div className="grid grid-cols-1 xl:grid-cols-10 gap-8">
          ...
          <div className="xl:col-span-7">
            <EquipmentShop selectedTab={selectedTab} />
          </div>
        </div>
      </div>
    </div>
